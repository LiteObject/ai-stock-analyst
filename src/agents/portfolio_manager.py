"""Portfolio management agent for making final trading decisions."""
...
def portfolio_management_agent(state: AgentState):
    ...
    Weighs signals from all analysts and risk management constraints
    ...
    # Invoke the LLM using the abstraction layer
    llm = get_llm()
